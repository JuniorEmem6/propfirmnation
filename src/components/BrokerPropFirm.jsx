...
const PropFirmsBrokersPage = () => {
  const propFirms = [
    ...
    },
    {
      ...
      logo: InstantFunding,
      description:
        "Instant execution, payouts, and support for those who break barriers.",
      rating: 4.5,
      discount: "ERAGON",
  ...
  const brokers = [
    ...
    },
    {
      ...
      logo: Headway,
      description:
        "Award-winning broker with tight spreads and fast execution.",
      rating: 4.8,
      bonus: "111 Bonus",
      minDeposit: "$2",
      regulation: "FCA, ASIC",
    ...
    <div className="bg-linear-to-b from-gray-900 to-gray-800 min-h-screen text-gray-200">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto text-center mb-12">
          Compare the best proprietary trading firms and brokers with exclusive
          discounts and bonuses available only through our links.
        </p>
            ...
            {propFirms.map((firm) => (
              <div
                ...
                className={`bg-gray-800 rounded-xl overflow-hidden border ${
                  firm.featured ? "border-teal-500/50" : "border-gray-700"
                    ...
                    <div className="bg-linear-to-r from-teal-500/10 to-teal-500/5 border border-teal-500/30 rounded-lg p-3 mb-5">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="flex items-center">
                            <p className="font-bold text-teal-400 mr-2">
                              {firm.discount}
                            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {brokers.map((broker) => (
              <div
                key={broker.id}
                className={`bg-gray-800 rounded-xl overflow-hidden border ${
                  broker.featured ? "border-indigo-500/50" : "border-gray-700"
        ...
        <div className="mt-20 bg-linear-to-r from-gray-800 to-gray-900 border border-gray-300 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mb-6">
            We partner with additional proprietary trading firms and brokers.
            Contact us for personalized recommendations based on your trading
            style.
          </p>
          <a
